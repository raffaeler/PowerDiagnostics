...
public class InvestigationScopeTests
{
    ...
    {
        var analyzer = Substitute.For<DiagnosticAnalyzer>();
        var scope = new InvestigationScope(Guid.NewGuid(), InvestigationKind.Dump, analyzer);
    ...
    public void Constructor_SetsCreatedToNow()
    {
        ...
        var scope = new InvestigationScope(Guid.NewGuid(), InvestigationKind.Snapshot, analyzer);
    ...
    public void Constructor_TemporaryFile_CanBeSet()
    {
        ...
        var scope = new InvestigationScope(Guid.NewGuid(), InvestigationKind.Dump, analyzer, tempFile);
